...
public class GpsServices extends Service implements LocationListener, GpsStatus.Listener {
    ...
    public void onLocationChanged(Location location) {
        ...
        if (data.isRunning()) {
            ...
            double myDistance=data.getDistance();
    ...
    public void updateNotification(boolean asData) {
        ...
        @SuppressLint({"NewApi", "LocalSuppress"}) Notification notification = builder.build();
        startForeground(R.string.noti_id, notification);
    }

    @Override
    public int onStartCommand(Intent intent, int flags, int startId) {
        new DoHeavyTask().execute();
    ...
    class isStillStopped extends AsyncTask<Void, Integer, String> {
        ...
        protected void onPostExecute(String message) {
            ...
            Toast.makeText(GpsServices.this, "GetStoppedTime\n" + message, Toast.LENGTH_SHORT).show();
        }
    }

    class DoHeavyTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            Toast.makeText(GpsServices.this,"START SERVICE", Toast.LENGTH_SHORT).show();
        }
    }
}
