...
public class LocationMonitoringService extends Service implements
    ...
    public void onLocationChanged(Location location) {
        ...
        if (location != null) {
            ...
            AutoRideDriverApps.LOCATION = location;

            latitude = location.getLatitude();
            longitude = location.getLongitude();
            myLatLng = getLatLong(latitude, longitude);
    ...
    private LatLng getLatLong(Double latitude, Double longitude) {
   ...
   //     Toast.makeText(this, getString(R.string.service_destroy), Toast.LENGTH_SHORT).show();
    ...
    class DoHeavyTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
           ...
           // Toast.makeText(LocationMonitoringService.this, getString(R.string.service_start), Toast.LENGTH_SHORT).show();
        }
    }
