...
public class SpeedMeterActivity extends AppCompatActivity implements LocationListener, GpsStatus.Listener {
        ...
        t.scheduleAtFixedRate(new TimerTask() {
                                  ...
                                  public void run() {
                                      ...
                                      if (cromometerTime != null) {
                                          ...
                                          SpeedMeterActivity.this.runOnUiThread(new Runnable() {
                                              public void run() {
                                                  double farePerSecond = 300 / 60;
                                                  double fareTotal = (farePerSecond * waitingTime) / 100;
                                                  TextView textWaitingFare = (TextView) findViewById(R.id.textWaitingFare);
                                                  textWaitingFare.setText(getString(R.string.txt_taka) + " " + (new DecimalFormat("##.##").format(fareTotal)));
                                                  //  Toast.makeText(SpeedMeterActivity.this, "WAITING TIME \n" + waitingTime, Toast.LENGTH_SHORT).show();
                                              }
                                          });
                                      }
                                  }
