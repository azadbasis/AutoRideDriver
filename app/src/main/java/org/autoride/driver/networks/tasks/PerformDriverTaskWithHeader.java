...
public class PerformDriverTaskWithHeader extends AsyncTask<String, Integer, DriverInfo> implements AppsConstants {
    ...
    public PerformDriverTaskWithHeader(String methods, String url, JSONObject postBody, JSONObject postHeader) {
