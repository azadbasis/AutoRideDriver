...
public class MobileAvailabilityCheckInvoker extends BaseInvoker implements DriverApiUrl {

    public MobileAvailabilityCheckInvoker() {
        super();
    }

    public MobileAvailabilityCheckInvoker(HashMap<String, String> urlParams, JSONObject postData) {
